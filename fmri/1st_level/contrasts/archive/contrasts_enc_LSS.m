function [conds, contrast, convecs, onsets, durations] = contrasts_enc_LSS(behavior,condition,model_duration)
...
index_enc_trials = strcmp(behavior.trial_type, 'Enc');
enc_trials = behavior(index_enc_trials, :);
...
logicalIndex2 = strcmp(trialOfInterest, enc_trials.item);
onsetTrialOfInterest = enc_trials.onset(logicalIndex2);

logicalIndex3 = ~strcmp(trialOfInterest, enc_trials.item);
onsetsOthers = enc_trials.onset(logicalIndex3);
